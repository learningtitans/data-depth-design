...
# ========== Experiment Seq. Idx. 1232 / 61.6.3 / N. 43/0/3 - _S=61.6.3 D1_N=43 a=-1 b=1 c=1 d=-1 e=1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=3 j=3 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.43.layer.0.test.3.index.3159.nosvm"
