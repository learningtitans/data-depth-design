...
# ========== Experiment Seq. Idx. 639 / 31.7.5 / N. 16/1/4 - _S=31.7.5 D1_N=16 a=-1 b=-1 c=-1 d=-1 e=1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=4 j=4 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.16.layer.1.test.4.index.1727.nosvm"
