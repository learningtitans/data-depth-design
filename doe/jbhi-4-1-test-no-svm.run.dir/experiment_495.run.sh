...
# ========== Experiment Seq. Idx. 495 / 24.7.1 / N. 7/1/1 - _S=24.7.1 D1_N=7 a=1 b=1 c=1 d=-1 e=-1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.7.layer.1.test.1.index.1387.nosvm"
