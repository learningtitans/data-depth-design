...
# ========== Experiment Seq. Idx. 141 / 7.2.2 / N. 15/4/0 - _S=7.2.2 D1_N=15 a=1 b=1 c=1 d=1 e=-1 f=-1 D3_N=4 g=1 h=-1 i=-1 D4_N=0 j=0 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.15.layer.4.test.0.index.542.nosvm"
