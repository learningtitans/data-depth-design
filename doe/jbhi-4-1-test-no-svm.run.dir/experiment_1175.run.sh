...
# ========== Experiment Seq. Idx. 1175 / 58.7.1 / N. 60/1/1 - _S=58.7.1 D1_N=60 a=-1 b=-1 c=-1 d=1 e=1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.60.layer.1.test.1.index.3019.nosvm"
