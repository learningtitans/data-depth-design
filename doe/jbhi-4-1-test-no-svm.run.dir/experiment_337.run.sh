...
# ========== Experiment Seq. Idx. 337 / 16.7.3 / N. 9/1/3 - _S=16.7.3 D1_N=9 a=1 b=-1 c=-1 d=1 e=-1 f=-1 D3_N=1 g=-1 h=-1 i=1 D4_N=3 j=3 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.9.layer.1.test.3.index.1005.nosvm"
