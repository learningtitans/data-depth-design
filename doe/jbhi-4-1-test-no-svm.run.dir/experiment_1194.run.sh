...
# ========== Experiment Seq. Idx. 1194 / 59.6.5 / N. 37/0/4 - _S=59.6.5 D1_N=37 a=1 b=1 c=-1 d=1 e=-1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=4 j=4 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.37.layer.0.test.4.index.3065.nosvm"
