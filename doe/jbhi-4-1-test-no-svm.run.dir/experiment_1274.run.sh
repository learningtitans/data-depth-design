...
# ========== Experiment Seq. Idx. 1274 / 63.6.5 / N. 40/0/4 - _S=63.6.5 D1_N=40 a=-1 b=-1 c=-1 d=-1 e=1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=4 j=4 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.40.layer.0.test.4.index.3257.nosvm"
