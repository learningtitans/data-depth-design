...
# ========== Experiment Seq. Idx. 1204 / 60.2.5 / N. 38/4/4 - _S=60.2.5 D1_N=38 a=1 b=-1 c=1 d=1 e=-1 f=-1 D3_N=4 g=1 h=-1 i=-1 D4_N=4 j=4 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.38.layer.4.test.4.index.3089.nosvm"
