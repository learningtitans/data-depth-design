...
# ========== Experiment Seq. Idx. 610 / 30.6.1 / N. 10/0/1 - _S=30.6.1 D1_N=10 a=-1 b=1 c=-1 d=1 e=-1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.10.layer.0.test.1.index.1669.nosvm"
