...
# ========== Experiment Seq. Idx. 168 / 8.4.4 / N. 27/5/2 - _S=8.4.4 D1_N=27 a=1 b=1 c=-1 d=1 e=1 f=-1 D3_N=5 g=1 h=-1 i=1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.27.layer.5.test.2.index.604.nosvm"
