...
# ========== Experiment Seq. Idx. 1098 / 54.7.4 / N. 49/1/2 - _S=54.7.4 D1_N=49 a=1 b=1 c=-1 d=-1 e=-1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.49.layer.1.test.2.index.2830.nosvm"
