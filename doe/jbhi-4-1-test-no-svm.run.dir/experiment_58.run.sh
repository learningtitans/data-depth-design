...
# ========== Experiment Seq. Idx. 58 / 2.7.4 / N. 0/1/2 - _S=2.7.4 D1_N=0 a=-1 b=-1 c=-1 d=-1 e=-1 f=-1 D3_N=1 g=-1 h=-1 i=1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.0.layer.1.test.2.index.334.nosvm"
