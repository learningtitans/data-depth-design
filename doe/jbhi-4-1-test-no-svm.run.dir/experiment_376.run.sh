...
# ========== Experiment Seq. Idx. 376 / 18.7.2 / N. 19/1/0 - _S=18.7.2 D1_N=19 a=1 b=1 c=-1 d=-1 e=1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=0 j=0 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.19.layer.1.test.0.index.1100.nosvm"
