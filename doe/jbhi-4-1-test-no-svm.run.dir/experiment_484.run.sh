...
# ========== Experiment Seq. Idx. 484 / 24.2.5 / N. 7/4/4 - _S=24.2.5 D1_N=7 a=1 b=1 c=1 d=-1 e=-1 f=1 D3_N=4 g=1 h=-1 i=-1 D4_N=4 j=4 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.7.layer.4.test.4.index.1361.nosvm"
