...
# ========== Experiment Seq. Idx. 880 / 44.2.1 / N. 62/4/1 - _S=44.2.1 D1_N=62 a=1 b=-1 c=1 d=1 e=1 f=1 D3_N=4 g=1 h=-1 i=-1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.62.layer.4.test.1.index.2317.nosvm"
