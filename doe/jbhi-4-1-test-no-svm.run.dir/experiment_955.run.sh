...
# ========== Experiment Seq. Idx. 955 / 47.7.1 / N. 59/1/1 - _S=47.7.1 D1_N=59 a=1 b=1 c=1 d=-1 e=1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.59.layer.1.test.1.index.2491.nosvm"
