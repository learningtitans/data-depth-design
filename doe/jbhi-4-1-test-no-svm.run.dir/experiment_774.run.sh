...
# ========== Experiment Seq. Idx. 774 / 38.6.5 / N. 36/0/4 - _S=38.6.5 D1_N=36 a=-1 b=-1 c=-1 d=1 e=-1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=4 j=4 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.36.layer.0.test.4.index.2057.nosvm"
