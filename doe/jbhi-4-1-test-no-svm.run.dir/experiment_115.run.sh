...
# ========== Experiment Seq. Idx. 115 / 5.7.1 / N. 11/1/1 - _S=5.7.1 D1_N=11 a=1 b=1 c=-1 d=1 e=-1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.11.layer.1.test.1.index.475.nosvm"
