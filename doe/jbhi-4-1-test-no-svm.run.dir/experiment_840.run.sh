...
# ========== Experiment Seq. Idx. 840 / 42.2.1 / N. 52/4/1 - _S=42.2.1 D1_N=52 a=1 b=-1 c=-1 d=1 e=-1 f=1 D3_N=4 g=1 h=-1 i=-1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.52.layer.4.test.1.index.2221.nosvm"
