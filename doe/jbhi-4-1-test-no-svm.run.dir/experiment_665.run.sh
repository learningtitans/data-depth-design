...
# ========== Experiment Seq. Idx. 665 / 33.4.1 / N. 61/5/1 - _S=33.4.1 D1_N=61 a=1 b=1 c=-1 d=1 e=1 f=1 D3_N=5 g=1 h=-1 i=1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.61.layer.5.test.1.index.1801.nosvm"
