...
# ========== Experiment Seq. Idx. 1088 / 54.4.4 / N. 49/5/2 - _S=54.4.4 D1_N=49 a=1 b=1 c=-1 d=-1 e=-1 f=1 D3_N=5 g=1 h=-1 i=1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.49.layer.5.test.2.index.2812.nosvm"
