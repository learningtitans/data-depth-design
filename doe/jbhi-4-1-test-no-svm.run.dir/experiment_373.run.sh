...
# ========== Experiment Seq. Idx. 373 / 18.6.4 / N. 19/0/2 - _S=18.6.4 D1_N=19 a=1 b=1 c=-1 d=-1 e=1 f=1 D3_N=0 g=-1 h=-1 i=-1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.19.layer.0.test.2.index.1096.nosvm"
