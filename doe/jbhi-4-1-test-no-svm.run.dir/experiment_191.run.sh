...
# ========== Experiment Seq. Idx. 191 / 9.6.2 / N. 18/0/0 - _S=9.6.2 D1_N=18 a=-1 b=1 c=-1 d=-1 e=1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=0 j=0 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.18.layer.0.test.0.index.662.nosvm"
