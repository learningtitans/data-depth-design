...
# ========== Experiment Seq. Idx. 798 / 39.7.4 / N. 33/1/2 - _S=39.7.4 D1_N=33 a=-1 b=1 c=-1 d=-1 e=-1 f=-1 D3_N=1 g=-1 h=-1 i=1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.33.layer.1.test.2.index.2110.nosvm"
