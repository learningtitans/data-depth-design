...
# ========== Experiment Seq. Idx. 698 / 34.7.4 / N. 53/1/2 - _S=34.7.4 D1_N=53 a=-1 b=1 c=-1 d=1 e=-1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.53.layer.1.test.2.index.1870.nosvm"
