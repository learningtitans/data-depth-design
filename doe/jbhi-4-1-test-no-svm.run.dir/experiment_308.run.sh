...
# ========== Experiment Seq. Idx. 308 / 15.4.4 / N. 22/5/2 - _S=15.4.4 D1_N=22 a=-1 b=1 c=1 d=-1 e=1 f=1 D3_N=5 g=1 h=-1 i=1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.22.layer.5.test.2.index.940.nosvm"
