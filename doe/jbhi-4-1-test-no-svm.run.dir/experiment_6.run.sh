...
# ========== Experiment Seq. Idx. 6 / 0.4.2 / N. 28/5/0 - _S=0.4.2 D1_N=28 a=-1 b=-1 c=1 d=1 e=1 f=1 D3_N=5 g=1 h=-1 i=1 D4_N=0 j=0 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.28.layer.5.test.0.index.218.nosvm"
