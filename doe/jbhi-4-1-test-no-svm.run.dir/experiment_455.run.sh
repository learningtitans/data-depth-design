...
# ========== Experiment Seq. Idx. 455 / 22.7.1 / N. 14/1/1 - _S=22.7.1 D1_N=14 a=-1 b=1 c=1 d=1 e=-1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.14.layer.1.test.1.index.1291.nosvm"
