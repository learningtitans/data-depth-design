...
# ========== Experiment Seq. Idx. 342 / 17.0.3 / N. 13/7/3 - _S=17.0.3 D1_N=13 a=1 b=-1 c=1 d=1 e=-1 f=1 D3_N=7 g=1 h=1 i=1 D4_N=3 j=3 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.13.layer.7.test.3.index.1011.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.13.layer.7.test.3.index.1011.svm"
