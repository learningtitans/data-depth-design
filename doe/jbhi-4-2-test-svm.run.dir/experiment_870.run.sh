...
# ========== Experiment Seq. Idx. 870 / 43.3.1 / N. 35/2/1 - _S=43.3.1 D1_N=35 a=1 b=1 c=1 d=-1 e=-1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=1 j=1 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.35.layer.2.test.1.index.2275.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.35.layer.2.test.1.index.2275.svm"
