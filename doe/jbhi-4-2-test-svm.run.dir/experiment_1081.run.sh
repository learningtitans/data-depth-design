...
# ========== Experiment Seq. Idx. 1081 / 54.0.2 / N. 49/7/0 - _S=54.0.2 D1_N=49 a=1 b=1 c=-1 d=-1 e=-1 f=1 D3_N=7 g=1 h=1 i=1 D4_N=0 j=0 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.49.layer.7.test.0.index.2786.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.49.layer.7.test.0.index.2786.svm"
