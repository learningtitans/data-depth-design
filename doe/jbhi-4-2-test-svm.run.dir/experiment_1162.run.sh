...
# ========== Experiment Seq. Idx. 1162 / 58.0.3 / N. 60/7/3 - _S=58.0.3 D1_N=60 a=-1 b=-1 c=-1 d=1 e=1 f=1 D3_N=7 g=1 h=1 i=1 D4_N=3 j=3 ==========
set -u
...
SVM_PREFIX="$SVM_DIR/deep.60.layer.7.svm"
SVM_PATH="$SVM_PREFIX.pkl"
FEATURES_DIR="$JBHI_DIR/features"
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.60.layer.7.test.3.index.2979.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.60.layer.7.test.3.index.2979.svm"
