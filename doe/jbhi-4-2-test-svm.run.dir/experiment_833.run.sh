...
# ========== Experiment Seq. Idx. 833 / 41.3.4 / N. 51/2/2 - _S=41.3.4 D1_N=51 a=-1 b=1 c=1 d=-1 e=-1 f=1 D3_N=2 g=-1 h=1 i=-1 D4_N=2 j=2 ==========
set -u
...
SVM_PREFIX="$SVM_DIR/deep.51.layer.2.svm"
SVM_PATH="$SVM_PREFIX.pkl"
FEATURES_DIR="$JBHI_DIR/features"
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.51.layer.2.test.2.index.2182.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.51.layer.2.test.2.index.2182.svm"
