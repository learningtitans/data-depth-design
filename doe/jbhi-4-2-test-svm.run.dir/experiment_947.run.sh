...
# ========== Experiment Seq. Idx. 947 / 47.1.3 / N. 59/3/3 - _S=47.1.3 D1_N=59 a=1 b=1 c=1 d=-1 e=1 f=1 D3_N=3 g=-1 h=1 i=1 D4_N=3 j=3 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.59.layer.3.test.3.index.2457.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.59.layer.3.test.3.index.2457.svm"
