...
# ========== Experiment Seq. Idx. 894 / 44.3.5 / N. 62/2/4 - _S=44.3.5 D1_N=62 a=1 b=-1 c=1 d=1 e=1 f=1 D3_N=2 g=-1 h=1 i=-1 D4_N=4 j=4 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.62.layer.2.test.4.index.2327.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.62.layer.2.test.4.index.2327.svm"
