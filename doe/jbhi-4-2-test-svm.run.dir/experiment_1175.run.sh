...
# ========== Experiment Seq. Idx. 1175 / 58.5.1 / N. 60/6/1 - _S=58.5.1 D1_N=60 a=-1 b=-1 c=-1 d=1 e=1 f=1 D3_N=6 g=1 h=1 i=-1 D4_N=1 j=1 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.60.layer.6.test.1.index.3007.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.60.layer.6.test.1.index.3007.svm"
