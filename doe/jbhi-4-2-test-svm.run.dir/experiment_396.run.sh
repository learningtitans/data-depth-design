...
# ========== Experiment Seq. Idx. 396 / 19.5.2 / N. 24/6/0 - _S=19.5.2 D1_N=24 a=-1 b=-1 c=-1 d=1 e=1 f=-1 D3_N=6 g=1 h=1 i=-1 D4_N=0 j=0 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.24.layer.6.test.0.index.1136.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.24.layer.6.test.0.index.1136.svm"
