...
# ========== Experiment Seq. Idx. 908 / 45.1.4 / N. 58/3/2 - _S=45.1.4 D1_N=58 a=-1 b=-1 c=1 d=-1 e=1 f=1 D3_N=3 g=-1 h=1 i=1 D4_N=2 j=2 ==========
set -u
...
SVM_PREFIX="$SVM_DIR/deep.58.layer.3.svm"
SVM_PATH="$SVM_PREFIX.pkl"
FEATURES_DIR="$JBHI_DIR/features"
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.58.layer.3.test.2.index.2362.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.58.layer.3.test.2.index.2362.svm"
