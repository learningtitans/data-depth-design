...
# ========== Experiment Seq. Idx. 40 / 2.0.1 / N. 0/7/1 - _S=2.0.1 D1_N=0 a=-1 b=-1 c=-1 d=-1 e=-1 f=-1 D3_N=7 g=1 h=1 i=1 D4_N=1 j=1 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.0.layer.7.test.1.index.289.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.0.layer.7.test.1.index.289.svm"
