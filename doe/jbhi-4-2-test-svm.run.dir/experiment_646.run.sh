...
# ========== Experiment Seq. Idx. 646 / 32.1.2 / N. 32/3/0 - _S=32.1.2 D1_N=32 a=1 b=-1 c=-1 d=-1 e=-1 f=-1 D3_N=3 g=-1 h=1 i=1 D4_N=0 j=0 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.32.layer.3.test.0.index.1736.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.32.layer.3.test.0.index.1736.svm"
