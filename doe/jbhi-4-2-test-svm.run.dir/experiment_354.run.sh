...
# ========== Experiment Seq. Idx. 354 / 17.3.5 / N. 13/2/4 - _S=17.3.5 D1_N=13 a=1 b=-1 c=1 d=1 e=-1 f=1 D3_N=2 g=-1 h=1 i=-1 D4_N=4 j=4 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.13.layer.2.test.4.index.1031.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.13.layer.2.test.4.index.1031.svm"
