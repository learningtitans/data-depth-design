...
# ========== Experiment Seq. Idx. 283 / 14.0.4 / N. 1/7/2 - _S=14.0.4 D1_N=1 a=1 b=-1 c=-1 d=-1 e=-1 f=1 D3_N=7 g=1 h=1 i=1 D4_N=2 j=2 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.1.layer.7.test.2.index.868.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.1.layer.7.test.2.index.868.svm"
