...
# ========== Experiment Seq. Idx. 510 / 25.3.1 / N. 17/2/1 - _S=25.3.1 D1_N=17 a=1 b=-1 c=-1 d=-1 e=1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=1 j=1 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.17.layer.2.test.1.index.1411.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.17.layer.2.test.1.index.1411.svm"
