...
# ========== Experiment Seq. Idx. 1219 / 60.5.5 / N. 38/6/4 - _S=60.5.5 D1_N=38 a=1 b=-1 c=1 d=1 e=-1 f=-1 D3_N=6 g=1 h=1 i=-1 D4_N=4 j=4 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.38.layer.6.test.4.index.3107.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.38.layer.6.test.4.index.3107.svm"
