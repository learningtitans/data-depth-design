...
# ========== Experiment Seq. Idx. 1189 / 59.1.5 / N. 37/3/4 - _S=59.1.5 D1_N=37 a=1 b=1 c=-1 d=1 e=-1 f=-1 D3_N=3 g=-1 h=1 i=1 D4_N=4 j=4 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.37.layer.3.test.4.index.3035.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.37.layer.3.test.4.index.3035.svm"
