...
# ========== Experiment Seq. Idx. 124 / 6.0.5 / N. 3/7/4 - _S=6.0.5 D1_N=3 a=1 b=1 c=-1 d=-1 e=-1 f=-1 D3_N=7 g=1 h=1 i=1 D4_N=4 j=4 ==========
set -u
...
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.3.layer.7.test.4.index.485.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.3.layer.7.test.4.index.485.svm"
