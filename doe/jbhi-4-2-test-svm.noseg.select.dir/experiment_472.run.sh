...
# ========== Experiment Seq. Idx. 472 / 23.3.3 / N. 20/2/3 - _S=23.3.3 D1_N=20 a=-1 b=-1 c=1 d=-1 e=1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=3 j=3 ==========
set -u
...
SVM_PREFIX="$SVM_DIR/deep.20.layer.2.svm"
SVM_PATH="$SVM_PREFIX.pkl"
FEATURES_DIR="$JBHI_DIR/features"
TEST_FEATURES_PREFIX="$FEATURES_DIR/deep.20.layer.2.test.3.index.1317.test"
TEST_FEATURES_PATH="$TEST_FEATURES_PREFIX.feats.pkl"
RESULTS_DIR="$JBHI_DIR/results"
RESULTS_PREFIX="$RESULTS_DIR/deep.20.layer.2.test.3.index.1317.svm"
