...
# ========== Experiment Seq. Idx. 1028 / 51.4.4 / N. 47/5/2 - _S=51.4.4 D1_N=47 a=1 b=1 c=1 d=1 e=1 f=-1 D3_N=5 g=1 h=-1 i=1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.47.layer.5.test.2.index.2668.nosvm"
