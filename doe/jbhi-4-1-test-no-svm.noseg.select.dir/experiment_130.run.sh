...
# ========== Experiment Seq. Idx. 130 / 6.6.1 / N. 3/0/1 - _S=6.6.1 D1_N=3 a=1 b=1 c=-1 d=-1 e=-1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.3.layer.0.test.1.index.517.nosvm"
