...
# ========== Experiment Seq. Idx. 993 / 49.6.4 / N. 44/0/2 - _S=49.6.4 D1_N=44 a=1 b=-1 c=-1 d=1 e=1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.44.layer.0.test.2.index.2584.nosvm"
