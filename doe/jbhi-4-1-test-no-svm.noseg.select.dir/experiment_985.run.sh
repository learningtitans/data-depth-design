...
# ========== Experiment Seq. Idx. 985 / 49.4.1 / N. 44/5/1 - _S=49.4.1 D1_N=44 a=1 b=-1 c=-1 d=1 e=1 f=-1 D3_N=5 g=1 h=-1 i=1 D4_N=1 j=1 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.44.layer.5.test.1.index.2569.nosvm"
