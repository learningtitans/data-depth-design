...
# ========== Experiment Seq. Idx. 272 / 13.6.3 / N. 29/0/3 - _S=13.6.3 D1_N=29 a=1 b=-1 c=1 d=1 e=1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=3 j=3 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.29.layer.0.test.3.index.855.nosvm"
