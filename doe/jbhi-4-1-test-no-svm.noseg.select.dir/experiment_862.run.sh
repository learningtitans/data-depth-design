...
# ========== Experiment Seq. Idx. 862 / 43.2.3 / N. 35/4/3 - _S=43.2.3 D1_N=35 a=1 b=1 c=1 d=-1 e=-1 f=-1 D3_N=4 g=1 h=-1 i=-1 D4_N=3 j=3 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.35.layer.4.test.3.index.2271.nosvm"
