...
# ========== Experiment Seq. Idx. 166 / 8.4.2 / N. 27/5/0 - _S=8.4.2 D1_N=27 a=1 b=1 c=-1 d=1 e=1 f=-1 D3_N=5 g=1 h=-1 i=1 D4_N=0 j=0 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.27.layer.5.test.0.index.602.nosvm"
