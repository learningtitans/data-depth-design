...
# ========== Experiment Seq. Idx. 607 / 30.4.3 / N. 10/5/3 - _S=30.4.3 D1_N=10 a=-1 b=1 c=-1 d=1 e=-1 f=-1 D3_N=5 g=1 h=-1 i=1 D4_N=3 j=3 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.10.layer.5.test.3.index.1659.nosvm"
