...
# ========== Experiment Seq. Idx. 429 / 21.4.5 / N. 23/5/4 - _S=21.4.5 D1_N=23 a=1 b=1 c=1 d=-1 e=1 f=-1 D3_N=5 g=1 h=-1 i=1 D4_N=4 j=4 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.23.layer.5.test.4.index.1229.nosvm"
