...
# ========== Experiment Seq. Idx. 713 / 35.6.4 / N. 41/0/2 - _S=35.6.4 D1_N=41 a=1 b=1 c=-1 d=-1 e=1 f=-1 D3_N=0 g=-1 h=-1 i=-1 D4_N=2 j=2 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.41.layer.0.test.2.index.1912.nosvm"
