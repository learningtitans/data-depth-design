...
# ========== Experiment Seq. Idx. 221 / 11.2.2 / N. 12/4/0 - _S=11.2.2 D1_N=12 a=-1 b=-1 c=1 d=1 e=-1 f=-1 D3_N=4 g=1 h=-1 i=-1 D4_N=0 j=0 ==========
set -u
...
RESULTS_PREFIX="$RESULTS_DIR/deep.12.layer.4.test.0.index.734.nosvm"
