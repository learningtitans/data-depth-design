...
# ========== Experiment Seq. Idx. 2818 / 54.5.4.0 / N. 0 - _S=54.5.4.0 D1_N=49 a=1 b=1 c=-1 d=-1 e=-1 f=1 D3_N=6 g=1 h=1 i=-1 D4_N=2 j=2 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 2818 / 54.5.4.0 / N. 0 - _S=54.5.4.0 D1_N=49 a=1 b=1 c=-1 d=-1 e=-1 f=1 D3_N=6 g=1 h=1 i=-1 D4_N=2 j=2 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.49.layer.6.test.2.index.2818.$SVM_SUFFIX"
