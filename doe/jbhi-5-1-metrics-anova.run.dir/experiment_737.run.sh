...
# ========== Experiment Seq. Idx. 1077 / 18.3.3.0 / N. 0 - _S=18.3.3.0 D1_N=19 a=1 b=1 c=-1 d=-1 e=1 f=1 D3_N=2 g=-1 h=1 i=-1 D4_N=3 j=3 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 1077 / 18.3.3.0 / N. 0 - _S=18.3.3.0 D1_N=19 a=1 b=1 c=-1 d=-1 e=1 f=1 D3_N=2 g=-1 h=1 i=-1 D4_N=3 j=3 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.19.layer.2.test.3.index.1077.$SVM_SUFFIX"
