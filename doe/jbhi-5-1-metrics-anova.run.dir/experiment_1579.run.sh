...
# ========== Experiment Seq. Idx. 2087 / 39.3.5.0 / N. 0 - _S=39.3.5.0 D1_N=33 a=-1 b=1 c=-1 d=-1 e=-1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=4 j=4 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 2087 / 39.3.5.0 / N. 0 - _S=39.3.5.0 D1_N=33 a=-1 b=1 c=-1 d=-1 e=-1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=4 j=4 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.33.layer.2.test.4.index.2087.$SVM_SUFFIX"
