...
# ========== Experiment Seq. Idx. 2846 / 55.2.2.0 / N. 0 - _S=55.2.2.0 D1_N=34 a=-1 b=-1 c=1 d=-1 e=-1 f=-1 D3_N=4 g=1 h=-1 i=-1 D4_N=0 j=0 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 2846 / 55.2.2.0 / N. 0 - _S=55.2.2.0 D1_N=34 a=-1 b=-1 c=1 d=-1 e=-1 f=-1 D3_N=4 g=1 h=-1 i=-1 D4_N=0 j=0 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.34.layer.4.test.0.index.2846.$SVM_SUFFIX"
