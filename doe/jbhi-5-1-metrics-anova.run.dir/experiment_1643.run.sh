...
# ========== Experiment Seq. Idx. 2164 / 41.0.4.0 / N. 0 - _S=41.0.4.0 D1_N=51 a=-1 b=1 c=1 d=-1 e=-1 f=1 D3_N=7 g=1 h=1 i=1 D4_N=2 j=2 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 2164 / 41.0.4.0 / N. 0 - _S=41.0.4.0 D1_N=51 a=-1 b=1 c=1 d=-1 e=-1 f=1 D3_N=7 g=1 h=1 i=1 D4_N=2 j=2 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.51.layer.7.test.2.index.2164.$SVM_SUFFIX"
