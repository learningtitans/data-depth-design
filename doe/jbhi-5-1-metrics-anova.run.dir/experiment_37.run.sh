...
# ========== Experiment Seq. Idx. 237 / 0.7.3.0 / N. 0 - _S=0.7.3.0 D1_N=28 a=-1 b=-1 c=1 d=1 e=1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=3 j=3 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 237 / 0.7.3.0 / N. 0 - _S=0.7.3.0 D1_N=28 a=-1 b=-1 c=1 d=1 e=1 f=1 D3_N=1 g=-1 h=-1 i=1 D4_N=3 j=3 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.28.layer.1.test.3.index.237.$SVM_SUFFIX"
