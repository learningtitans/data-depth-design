...
# ========== Experiment Seq. Idx. 2246 / 42.6.2.0 / N. 0 - _S=42.6.2.0 D1_N=52 a=1 b=-1 c=-1 d=1 e=-1 f=1 D3_N=0 g=-1 h=-1 i=-1 D4_N=0 j=0 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 2246 / 42.6.2.0 / N. 0 - _S=42.6.2.0 D1_N=52 a=1 b=-1 c=-1 d=1 e=-1 f=1 D3_N=0 g=-1 h=-1 i=-1 D4_N=0 j=0 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.52.layer.0.test.0.index.2246.$SVM_SUFFIX"
