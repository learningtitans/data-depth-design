...
# ========== Experiment Seq. Idx. 1412 / 25.3.2.0 / N. 0 - _S=25.3.2.0 D1_N=17 a=1 b=-1 c=-1 d=-1 e=1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=0 j=0 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 1412 / 25.3.2.0 / N. 0 - _S=25.3.2.0 D1_N=17 a=1 b=-1 c=-1 d=-1 e=1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=0 j=0 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.17.layer.2.test.0.index.1412.$SVM_SUFFIX"
