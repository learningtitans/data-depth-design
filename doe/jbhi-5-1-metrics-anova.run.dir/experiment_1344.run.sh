...
# ========== Experiment Seq. Idx. 1805 / 33.4.5.0 / N. 0 - _S=33.4.5.0 D1_N=61 a=1 b=1 c=-1 d=1 e=1 f=1 D3_N=5 g=1 h=-1 i=1 D4_N=4 j=4 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 1805 / 33.4.5.0 / N. 0 - _S=33.4.5.0 D1_N=61 a=1 b=1 c=-1 d=1 e=1 f=1 D3_N=5 g=1 h=-1 i=1 D4_N=4 j=4 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.61.layer.5.test.4.index.1805.$SVM_SUFFIX"
