...
# ========== Experiment Seq. Idx. 2311 / 44.1.1.0 / N. 0 - _S=44.1.1.0 D1_N=62 a=1 b=-1 c=1 d=1 e=1 f=1 D3_N=3 g=-1 h=1 i=1 D4_N=1 j=1 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 2311 / 44.1.1.0 / N. 0 - _S=44.1.1.0 D1_N=62 a=1 b=-1 c=1 d=1 e=1 f=1 D3_N=3 g=-1 h=1 i=1 D4_N=1 j=1 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.62.layer.3.test.1.index.2311.$SVM_SUFFIX"
