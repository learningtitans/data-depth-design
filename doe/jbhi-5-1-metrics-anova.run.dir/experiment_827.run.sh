...
# ========== Experiment Seq. Idx. 1185 / 20.5.3.0 / N. 0 - _S=20.5.3.0 D1_N=4 a=-1 b=-1 c=1 d=-1 e=-1 f=1 D3_N=6 g=1 h=1 i=-1 D4_N=3 j=3 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 1185 / 20.5.3.0 / N. 0 - _S=20.5.3.0 D1_N=4 a=-1 b=-1 c=1 d=-1 e=-1 f=1 D3_N=6 g=1 h=1 i=-1 D4_N=3 j=3 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.4.layer.6.test.3.index.1185.$SVM_SUFFIX"
