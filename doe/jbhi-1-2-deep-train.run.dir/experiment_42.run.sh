...
# ========== Experiment Idx. 42 / Seq. 42 / N. 52 - _S=42 D1_N=52 a=1 b=-1 c=-1 d=1 e=-1 f=1 ==========\n\n'
set -u
...
LAST_OUTPUT="$OUTPUT_DIR/model.ckpt-40000.meta"
# EXPERIMENT_STATUS=1
# STARTED_BEFORE=No
mkdir -p "$MODEL_DIR"
...
python \
    ...
    --experiment_tag="Factorial: 52; _S D1_N a b c d e f" \
...
#    --checkpoint_path="$JBHI_DIR/running/inception_v4.ckpt" \
