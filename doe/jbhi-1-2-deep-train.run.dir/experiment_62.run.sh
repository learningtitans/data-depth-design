...
# ========== Experiment Idx. 62 / Seq. 62 / N. 42 - _S=62 D1_N=42 a=1 b=-1 c=1 d=-1 e=1 f=-1 ==========\n\n'
set -u
...
DATASET_DIR="$JBHI_DIR/data/challenge-train.598.tfr"
...
python \
    ...
    --experiment_tag="Factorial: 42; _S D1_N a b c d e f" \
