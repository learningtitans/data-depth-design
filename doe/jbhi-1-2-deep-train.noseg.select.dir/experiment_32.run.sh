...
# ========== Experiment Idx. 32 / Seq. 32 / N. 32 - _S=32 D1_N=32 a=1 b=-1 c=-1 d=-1 e=-1 f=-1 ==========\n\n'
set -u
...
DATASET_DIR="$JBHI_DIR/data/challenge-train.299.tfr"
...
python \
    ...
    --experiment_tag="Factorial: 32; _S D1_N a b c d e f" \
