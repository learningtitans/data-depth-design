...
# ========== Experiment Seq. Idx. 1659 / 30.4.3.0 / N. 0 - _S=30.4.3.0 D1_N=10 a=-1 b=1 c=-1 d=1 e=-1 f=-1 D3_N=5 g=1 h=-1 i=1 D4_N=3 j=3 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 1659 / 30.4.3.0 / N. 0 - _S=30.4.3.0 D1_N=10 a=-1 b=1 c=-1 d=1 e=-1 f=-1 D3_N=5 g=1 h=-1 i=1 D4_N=3 j=3 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.10.layer.5.test.3.index.1659.$SVM_SUFFIX"
