...
# ========== Experiment Seq. Idx. 2842 / 55.1.4.0 / N. 0 - _S=55.1.4.0 D1_N=34 a=-1 b=-1 c=1 d=-1 e=-1 f=-1 D3_N=3 g=-1 h=1 i=1 D4_N=2 j=2 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 2842 / 55.1.4.0 / N. 0 - _S=55.1.4.0 D1_N=34 a=-1 b=-1 c=1 d=-1 e=-1 f=-1 D3_N=3 g=-1 h=1 i=1 D4_N=2 j=2 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.34.layer.3.test.2.index.2842.$SVM_SUFFIX"
