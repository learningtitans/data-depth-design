...
# ========== Experiment Seq. Idx. 1556 / 28.3.2.0 / N. 0 - _S=28.3.2.0 D1_N=30 a=-1 b=1 c=1 d=1 e=1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=0 j=0 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 1556 / 28.3.2.0 / N. 0 - _S=28.3.2.0 D1_N=30 a=-1 b=1 c=1 d=1 e=1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=0 j=0 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.30.layer.2.test.0.index.1556.$SVM_SUFFIX"
