...
# ========== Experiment Seq. Idx. 2851 / 55.3.1.0 / N. 0 - _S=55.3.1.0 D1_N=34 a=-1 b=-1 c=1 d=-1 e=-1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=1 j=1 D5_N=0 ==========
set -u
# Prints header
echo -e '\n\n========== Experiment Seq. Idx. 2851 / 55.3.1.0 / N. 0 - _S=55.3.1.0 D1_N=34 a=-1 b=-1 c=1 d=-1 e=-1 f=-1 D3_N=2 g=-1 h=1 i=-1 D4_N=1 j=1 D5_N=0 ==========\n\n'
...
RESULTS_PREFIX="$RESULTS_DIR/deep.34.layer.2.test.1.index.2851.$SVM_SUFFIX"
